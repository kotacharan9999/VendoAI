...
from apps.api.services.demo_data import get_demo_agent_runs, run_demo_agent
...
async def list_agent_runs(
    ...
    if db is None:
        return get_demo_agent_runs(limit=limit)
    ...
    try:
        ...
        return runs if runs else get_demo_agent_runs(limit=limit)
    except Exception:
        return get_demo_agent_runs(limit=limit)
...
async def trigger_agent(
    ...
    if db is None:
        return run_demo_agent(data.agent_name, data.product_id)
